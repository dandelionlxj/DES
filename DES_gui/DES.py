...
def keytocode(key,code):
    ...
    for i in range(64):       
        avg=0
        print('明文不变，密钥改变'+str(i+1)+'位')
        #print('原始明文：'+code)
        for j in range(100):
            change=0
            changecode=encrypt('0011000000110001001100100011001100110100001101010011011000110111',des.changekey(key,i))
            #print('原始密文:'+code)
...
def from_codetocode(key,code):
    ...
    for i in range(64):       
        ...
        for j in range(100):
            change=0
            changecode=encrypt(des.changecode(code,i),'0011000100110010001100110011010000110101001101100011011100111000')
            #print('原始密钥:'+key)
            #print('改变后的密文：'+changecode)
            for a in range(64):
                if changecode[a]!=code[a]:
...
if __name__ == '__main__':
    #print('密文: '+encrypt('0011000000110001001100100011001100110100001101010011011000110111','0011000100110010001100110011010000110101001101100011011100111000'))
    #decrypt('1000101110110100011110100000110011110000101010010110001001101101','0011000100110010001100110011010000110101001101100011011100111000')
    #keytocode('0011000100110010001100110011010000110101001101100011011100111000','1000101110110100011110100000110011110000101010010110001001101101')
    from_codetocode('0011000100110010001100110011010000110101001101100011011100111000','1000101110110100011110100000110011110000101010010110001001101101')